...
CifA_matrice <- read.table(
  "C:/Users/Mael RICHON/Desktop/Rapport_stage/Mantel/CifA_matrice.txt",
  header = TRUE,
  row.names = 1,
  sep = ",",
  check.names = FALSE
...
CifB_matrice <- read.table(
  "C:/Users/Mael RICHON/Desktop/Rapport_stage/Mantel/CifB_matrice.txt",
  header = TRUE,
  row.names = 1,
  sep = ",",
  check.names = FALSE
...
CifA_matrice[] <- lapply(CifA_matrice, function(x) as.numeric(gsub("%", "", x)))
CifB_matrice[] <- lapply(CifB_matrice, function(x) as.numeric(gsub("%", "", x)))

cifA_hamming_dist <- as.dist(CifA_matrice)
cifB_hamming_dist <- as.dist(CifB_matrice)
