...
The domain characterization of all sequences of interest (both eukaryotic and bacterial) was performed using the HHpred platform, with the following reference databases: SCOPe70_2.08, Pfam-A_v37.4, COG_KOG_v1.0, and SMART_v6.
...
- weak sequence similarity over short regions
- convergent evolution of protein motifs
- alignment artifacts in low-complexity regions
